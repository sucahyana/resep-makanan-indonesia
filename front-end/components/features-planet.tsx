...
import PlanetTagImg01 from "@/public/images/ayam-taliwang-tag.png";
import PlanetTagImg02 from "@/public/images/gudeg-tag.png";
import PlanetTagImg03 from "@/public/images/pempek-tag.png";
import PlanetTagImg04 from "@/public/images/rendang-tag.png";
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Sajikan Resep Masakan Indonesia dengan Mudah dan Cepat melalui API
            </h2>
          </div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Statistik Instan</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Lihat statistik penggunaan API secara langsung, termasuk jumlah permintaan, respon, dan popularitas resep.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Setiap resep dilengkapi metadata seperti bahan, langkah memasak, kategori masakan, dan asal daerah.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                API mendukung integrasi data dengan struktur SEO friendly agar situs resep Anda mudah ditemukan di mesin pencari.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Tambahkan kode Anda sendiri dengan fleksibilitas tinggi. Cocok untuk berbagai platform frontend dan backend.
              </p>
            </article>
          </div>
        </div>
